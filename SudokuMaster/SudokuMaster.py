...
#Permet d'identifier les lignes en calculant le nombre de pixels qui se suivent par rapport à l'angle teta (radiant)
def line_identifier():
    global lines_list
    global pro_ligne
...
def possible(row, column, number):
    ...
    #Est-ce que le chiffre apparait dans le carré?
    x0 = (column // 3) * 3
    y0 = (row // 3) * 3
    for i in range(0,3):
        for j in range(0,3):
...
#Ajout dans un grid des éléments tkinter
